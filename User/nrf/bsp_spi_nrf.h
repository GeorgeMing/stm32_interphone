...
//#elif 1
#define NRF_CSN_HIGH()      GPIO_SetBits(GPIOB, GPIO_Pin_9)
#define NRF_CSN_LOW()       GPIO_ResetBits(GPIOB, GPIO_Pin_9)		        //csn置低
#define NRF_CE_HIGH()	      GPIO_SetBits(GPIOB,GPIO_Pin_8)
#define NRF_CE_LOW()	      GPIO_ResetBits(GPIOB,GPIO_Pin_8)			      //CE置低
#define NRF_Read_IRQ()		  GPIO_ReadInputDataBit ( GPIOC, GPIO_Pin_14)  //
//#endif
